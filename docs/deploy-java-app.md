...
| `build-artifact-name`          | Input          | `string` | The name of the artifact containing the build output from all the target directories in the project that a previous job in this workflow created and uploaded using the `upload-artifact` action. This job will download it using the `download-artifact` action. | artifact       |
| `deploy-scripts-artifact-name` | Input          | `string` | The name of the artifact containing the contents of the project's deploy directory that a previous job in this workflow created and uploaded using the `upload-artifact` action. This job will download it using the `download-artifact` action.                  | deploy-scripts |
